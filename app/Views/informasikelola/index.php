...
<div class="page-content-wrap">
    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 style="text-align: center;" class="panel-title"><strong>Tabel Pencatatan Keberadaan</strong></h4>
                <div class="panel-body panel-body-table">
                            ...
                            <table class="table table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="background-color: #3B9AE1; text-align: center; color: white;">TAHUN</th>
                                    ...
                                    ?>
                                        ...
                                        <tr style="text-align: center;" id="trow_<?= $no ?>">
                                            ...
                                            <td>
                                                ...
                                                <a style="width : 50%; text-align: center; margin-bottom: 5%;" class="btn btn-inverse-primary" href="<?= base_url('/informasikelolaskt/detail/' . $v['id_ormas']) ?>">Detail</a>
                                                <a style="width : 50%; text-align: center; margin-bottom: 5%;" class="btn btn-inverse-success" href="<?= base_url('/informasikelolaskt/ubah/' . $v['id_ormas']) ?>">Ubah</a>
                                                <a style="width : 50%; text-align: center;" class="btn btn-inverse-danger" href="<?= base_url('/informasikelolaskt/hapus/' . $v['id_ormas']) ?>" onClick="return confirm('Hapus Data Ini ?')">Hapus</a>
