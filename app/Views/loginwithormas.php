                ...
                <div class="row w-100 mx-0">
                    <div style="margin-top: -3%;" class="col-lg-4 mx-auto">
                        ...
                        <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                            ...
                            <form class="pt-3" method="post" action="<?= base_url('/loginWithOrmas') ?>">
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-lg" name="nama_organisasi" placeholder="Nama Organisasi">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-lg" name="no_induk" placeholder="Nomor SKT/SKAHU">
                                </div>
                                <div class="mb-4">
