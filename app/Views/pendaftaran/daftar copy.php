        ...
        <div class="card-body">
            <?php if (count($modelakses) > 0) : ?>
                ...
                <?php foreach ($model as $v) : ?>
                    <a style="width: 30%; text-align: center; margin-top: 20px;" class="btn btn-inverse-primary" href="<?= base_url('/pendaftaran/detailormas/' . $v['id_ormas']) ?>">Riwayat</a>
                    <a style="width : 30%; margin-left: 10px; text-align: center; margin-top: 20px;" class="btn btn-inverse-warning" href="<?= base_url('/pendaftaran/ubahakses/' . $v['id_ormas']) ?>">Ubah</a>
                    <a style="width : 30%; margin-left: 10px; text-align: center; margin-top: 20px;" class="btn btn-inverse-warning" href="<?= base_url('/proses/index1/' . $v['id_ormas']) ?>">Proses</a>
                <?php endforeach; ?>
            <?php else : ?>
