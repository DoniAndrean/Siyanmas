            ...
            <form class="form-sample">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a style="margin-top: 40px;" href="<?= base_url('/pendaftaran/index1') ?>" class="btn btn-inverse-primary">Kembali</a>
                        <a style="margin-top: 40px; margin-left: 10px;" href="<?= base_url('/pendaftaran/verify1/' . $modelOrmas[0]['id_ormas'] . '/2') ?>" class="btn btn-inverse-warning float-right">Verifikasi</a>
                    </div>
                </div>
            </form>
        </div>
