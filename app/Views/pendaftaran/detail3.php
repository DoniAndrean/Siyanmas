            ...
            <form class="form-sample">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a style="margin-top: 40px;" href="<?= base_url('/pendaftaran/index3') ?>" class="btn btn-inverse-primary">Kembali</a>
                        <a style="margin-top: 40px; margin-left: 10px;" href="<?= base_url('/pendaftaran/verify3/' . $modelOrmas[0]['id_ormas'] . '/4') ?>" class="btn btn-inverse-warning float-right">Verifikasi</a>
                    </div>
                </div>
            </form>
        </div>
