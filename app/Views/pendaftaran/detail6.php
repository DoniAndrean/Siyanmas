        ...
        <div class="card-body">
            ...
            <form class="form-sample">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <label class="col-md-3 col-xs-12 control-label">Nomor Keberadaan</label>
                            <div class="col-md-8 col-xs-12 control-label">
                                <div style="text-align: center;" class="input-group">
                    ...
                    <div class="card-body">
                        ...
                        <a style="margin-top: 40px;" href="<?= base_url('/pendaftaran/index6') ?>" class="btn btn-inverse-primary">Kembali</a>
                        <a style="margin-top: 40px; margin-left: 10px;" href="<?= base_url('/pendaftaran/verify6/' . $modelOrmas[0]['id_ormas'] . '/7') ?>" class="btn btn-inverse-warning float-right">Verifikasi</a>
                    </div>
                </div>
            </form>
        </div>
