                ...
                <div class="card">
                        ...
                        <div class="form-group row">
                            ...
                            ?>
                                <div class="col-md-3 col-xs-12">
                                    <a class="btn btn-primary" target="_blank" href="<?= base_url('/public/upload/' . $modelOrmas[0]['skt']) ?>">Download</a>
                                </div>
                            <?php
                            }
                            ?>
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            ?>
                                <div class="col-md-3 col-xs-12">
                                    <a class="btn btn-primary" target="_blank" href="<?= base_url('/public/upload/' . $modelOrmas[0]['sk_pengurus']) ?>">Download</a>
                                </div>
                            <?php
                            }
                            ?>
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            ?>
                                <div class="col-md-3 col-xs-12">
                                    <a class="btn btn-primary" target="_blank" href="<?= base_url('/public/upload/' . $modelOrmas[0]['program_kerja']) ?>">Download</a>
                                </div>
                            <?php
                            }
                            ?>
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            ?>
                                <div class="col-md-3 col-xs-12">
                                    <a class="btn btn-primary" target="_blank" href="<?= base_url('/public/upload/' . $modelOrmas[0]['akte_pendirian']) ?>">Download</a>
                                </div>
                            <?php
                            }
                            ?>
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            ?>
                                <div class="col-md-3 col-xs-12">
                                    <a class="btn btn-primary" target="_blank" href="<?= base_url('/public/upload/' . $modelOrmas[0]['ad_art']) ?>">Download</a>
                                </div>
                            <?php
                            }
                            ?>
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            ?>
                                <div class="col-md-3 col-xs-12">
                                    <a class="btn btn-primary" target="_blank" href="<?= base_url('/public/upload/' . $modelOrmas[0]['ktp_ketua']) ?>">Download</a>
                                </div>
                            <?php
                            }
                            ?>
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            ?>
                                <div class="col-md-3 col-xs-12">
                                    <a class="btn btn-primary" target="_blank" href="<?= base_url('/public/upload/' . $modelOrmas[0]['ktp_sekretaris']) ?>">Download</a>
                                </div>
                            <?php
                            }
                            ?>
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            ?>
                                <div class="col-md-3 col-xs-12">
                                    <a class="btn btn-primary" target="_blank" href="<?= base_url('/public/upload/' . $modelOrmas[0]['ktp_bendahara']) ?>">Download</a>
                                </div>
                            <?php
                            }
                            ?>
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            ?>
                                <div class="col-md-3 col-xs-12">
                                    <a class="btn btn-primary" target="_blank" href="<?= base_url('/public/upload/' . $modelOrmas[0]['foto_ketua']) ?>">Download</a>
                                </div>
                            <?php
                            }
                            ?>
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            ?>
                                <div class="col-md-3 col-xs-12">
                                    <a class="btn btn-primary" target="_blank" href="<?= base_url('/public/upload/' . $modelOrmas[0]['foto_sekretaris']) ?>">Download</a>
                                </div>
                            <?php
                            }
                            ?>
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            ?>
                                <div class="col-md-3 col-xs-12">
                                    <a class="btn btn-primary" target="_blank" href="<?= base_url('/public/upload/' . $modelOrmas[0]['foto_bendahara']) ?>">Download</a>
                                </div>
                            <?php
                            }
                            ?>
                        </div>
                        <a style="margin-top: 40px;" href="<?= base_url('/pendaftaran/daftar') ?>" class="btn btn-inverse-primary">Kembali</a>
                    </div>
                </div>
            </form>
        </div>
