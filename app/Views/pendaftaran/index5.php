                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr style="text-align: center;" id="trow_<?= $no ?>">
                                            ...
                                            <td>
                                                <a class="btn btn-inverse-primary" style="width: 50%; text-align: center; margin-bottom: 5%;" href="<?= base_url('/pendaftaran/detail5/' . $v['id_ormas']) ?>">Detail</a>
                                                <a class="btn btn-inverse-success" style="width: 50%; text-align: center; margin-bottom: 5%;" href="<?= base_url('/pendaftaran/ubah5/' . $v['id_ormas']) ?>">Ubah</a>
                                                <a class="btn btn-inverse-danger" style="width: 50%; text-align: center;" href="<?= base_url('/pendaftaran/hapus5/' . $v['id_ormas']) ?>" onClick="return confirm('Hapus Data Ini ?')">Hapus</a>
                                            </td>
                                        </tr>
                                    <?php
                                    }
