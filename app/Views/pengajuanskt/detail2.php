            ...
            <form class="form-sample">
                <div class="card">
                    ...
                    <div class="panel-footer">
                        <div class="card-body">
                            <a href="<?= base_url('/pengajuanskt/index2') ?>" class="btn btn-inverse-primary">Kembali</a>
                            <a href="<?= base_url('/pengajuanskt/verify2/' . $modelOrmas[0]['id_ormas'] . '/3') ?>" class="btn btn-inverse-warning pull-right">Verifikasi</a>
                        </div>
                    </div>
                </div>
            </form>
