            ...
            <form class="form-sample">
                <div class="card">
                    ...
                    <div class="panel-footer">
                        <div class="card-body">
                            <a href="<?= base_url('/pengajuanskt/index5') ?>" class="btn btn-inverse-primary">Kembali</a>
                            <a href="<?= base_url('/pengajuanskt/verify5/' . $modelOrmas[0]['id_ormas'] . '/6') ?>" class="btn btn-inverse-warning pull-right">Verifikasi</a>
                        </div>
                    </div>
                </div>
            </form>
