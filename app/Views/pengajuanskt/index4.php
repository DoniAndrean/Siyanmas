                                    ...
                                    ?>
                                        <tr id="trow_<?= $no ?>">
                                            ...
                                            <td>
                                                ...
                                                <a style="width : 70%; text-align: center; margin-bottom: 5%;" class="btn btn-inverse-primary" href="<?= base_url('/pengajuanskt/detail4/' . $v['id_ormas']) ?>">Detail</a>
                                                <a style="width : 70%; text-align: center; margin-bottom: 5%;" class="btn btn-inverse-success" href="<?= base_url('/pengajuanskt/ubah4/' . $v['id_ormas']) ?>">Ubah</a>
                                                <a style="width : 70%; text-align: center;" class="btn btn-inverse-danger" href="<?= base_url('/pengajuanskt/hapus4/' . $v['id_ormas']) ?>" onClick="return confirm('Hapus Data Ini ?')">Hapus</a>
