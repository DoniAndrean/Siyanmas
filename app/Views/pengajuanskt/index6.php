...
<div class="page-content-wrap">
    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 style="text-align: center;" class="panel-title"><strong>Tabel Pengajuan SKT</strong></h4>
                    ...
                    <form class="form-horizontal" method="POST" action="<?= base_url('/' . $url . '/ubah') ?>">
                        <div class="table-responsive pt-3">
                            <table class="table table-striped">
                                <thead>
                                    <tr>
                                        <th width="50" style="background-color: #3B9AE1; text-align: center; color: white;">NO</th>
                                        <th style="background-color: #3B9AE1; text-align: center; color: white;">NAMA ORGANISASI</th>
                                        <th width="200px" style="background-color: #3B9AE1; text-align: center; color: white; text-align: center;">ALAMAT</th>
                                        <th style="background-color: #3B9AE1; text-align: center; color: white;">TANGGAL</th>
                                        <th style="background-color: #3B9AE1; text-align: center; color: white; text-align: center ;">EMAIL</th>
                                        <th style=" width: 180px; background-color: #3B9AE1; text-align: center; color: white;">NOMOR HP</th>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr id="trow_<?= $no ?>">
                                            ...
                                            <td style="text-align: center;" style="text-align: center; " width="200px"><?= $v['alamat'] ?></td>
                                            <td style="text-align: center;"><?= $v['tanggal'] ?></td>
                                            <td style="text-align: center;" style="text-align:left ;"><?= $v['email'] ?></td>
                                            <td style="text-align: center; width: 100px;"><?= $v['nomor_hp'] ?></td>
                                            <td style="text-align: center;">
                                                <div style="display: inline-block; text-align: center;">
                                                    <a style="width: 50%; text-align: center; margin-bottom: 5%;" class="btn btn-inverse-primary" href="<?= base_url('/pengajuanskt/detail6/' . $v['id_ormas']) ?>">Detail</a>
                                                    <a style="width: 50%; text-align: center; margin-bottom: 5%;" class="btn btn-inverse-success" href="<?= base_url('/pengajuanskt/ubah6/' . $v['id_ormas']) ?>">Ubah</a>
                                                    <a style="width: 50%; text-align: center; margin-bottom: 5%;" class="btn btn-inverse-info" href="<?= base_url('/pengajuanskt/kirim/' . $v['id_ormas']) ?>">Kirim</a>
                                                    <a style="width: 50%; text-align: center;" class="btn btn-inverse-danger" href="<?= base_url('/pengajuanskt/hapus6/' . $v['id_ormas']) ?>" onClick="return confirm('Hapus Data Ini ?')">Hapus</a>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php
