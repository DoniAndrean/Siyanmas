        ...
        <div class="card-body">
            <?php if (count($modelakses) > 0) : ?>
                ...
                <?php foreach ($model as $v) : ?>
                    <a style="width: 31%; text-align: center; margin-top: 20px;" class="btn btn-inverse-primary" href="<?= base_url('/pengajuanskt/detailormas/' . $v['id_ormas']) ?>">Riwayat</a>
                    <a style="width : 31%; margin-left: 40px; text-align: center; margin-top: 20px;" class="btn btn-inverse-success" href="<?= base_url('/pengajuanskt/ubahormas/' . $v['id_ormas']) ?>">Ubah Data</a>
                    <a style="width : 31%; margin-left: 40px; text-align: center; margin-top: 20px;" class="btn btn-inverse-warning" href="<?= base_url('/proses/index/' . $v['id_ormas']) ?>">Proses</a>
                <?php endforeach; ?>
            <?php else : ?>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 col-xs-12 control-label">
                                            <div class="input-group">
                                                <input type="date" name="tanggal_buat" class="form-control" autofocus placeholder="" required oninvalid="this.setCustomValidity('Kolom Wajib di Isi')" oninput="setCustomValidity('')" />
                                                <span class="input-group-text bg-info text-white"><span class="fa fa-pencil"></span></span>
                                            </div>
                                        </div>
                                    </div>
