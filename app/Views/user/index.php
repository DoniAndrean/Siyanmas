                        ...
                        <div class="row">
                            <div class="col-md-6 col-xs-12 control-label"><br>
                                <div class="input-group">
                                    <input type="text" name="cari" class="form-control" autofocus placeholder="Nama User" />
                        ...
                        <table class="table table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th style="background-color: #3B9AE1; color: white; text-align: center;">Username</th>
                                    <th style="background-color: #3B9AE1; color: white; text-align: center;">Nama</th>
                                    <th style="background-color: #3B9AE1; color: white; text-align: center;">Level Akses</th>
                                    <th style="background-color: #3B9AE1; color: white; text-align: center;">Akses</th>
